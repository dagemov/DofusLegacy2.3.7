...
| [combat-telemetry-plan.md](../combat-sanitization/combat-telemetry-plan.md) | Plan de instrumentación y analizador |
...
| Fase | Estado |
| --- | --- |
| 1 — Auditoría | **DONE** (docs) |
| 2 — Combat Health Lab | **DONE** (scripts scaffolding) |
| 3 — Turn Transition Fix | Pendiente evidencia + logs |
| 4 — Spell Cast Telemetry | Pendiente |
