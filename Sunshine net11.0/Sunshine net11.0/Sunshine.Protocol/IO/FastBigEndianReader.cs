using Sunshine.Protocol.IO.Pool;
using System;
using System.IO;
using System.Text;

namespace Sunshine.Protocol.IO
{
    public unsafe class FastBigEndianReader : IDataReader, IDisposable
    {
        private int m_position;
        private readonly byte[] m_buffer;
        private int m_maxPosition = -1;
        ...
        public int BytesAvailable
        {
            get
            {
                return this.m_maxPosition > 0L ? this.m_maxPosition : (this.m_buffer.Length - this.Position);
            }
        }
        ...
        {
            this.m_buffer = segment.Buffer.Array;
            this.Position = segment.Offset;
            this.m_maxPosition = segment.Offset + segment.Length;
        }
